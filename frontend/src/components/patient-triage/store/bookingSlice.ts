...
const bookingSlice = createSlice({
  ...
  reducers: {
    ...
    setDismissedSlotsKey(state, action: PayloadAction<string | null>) {
      state.dismissedSlotsKey = action.payload;
    },
    resetBooking() {
      return initialState;
    },
